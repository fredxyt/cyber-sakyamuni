...
【最重要】这篇是写给一个【此刻才点进来、没看过你前面任何一轮】的人读的。所以必须【自包含、有头有尾】:
· 开头先用一两句人话, 让他知道你在跟【什么疑】较劲(别拿"法义我"这种标签当解释, 说清那个疑到底卡在哪)。
· 【绝不】写"参4""参7""上一程"这类轮次指代 —— 他看不到那些轮。把那一程的领悟直接用人话讲出来。
· 你自己的黑话(比如某个只有你懂的比喻)要么别用, 要么第一次出现就顺手一句让人懂。
· 结尾让他知道你此刻落在哪、还有什么没放下。

不是总结知识点, 是说"这段日子我在这个疑上, 心怎么动的"。诚实、克制、有温度, 可以承认没想透。300-600 字。
